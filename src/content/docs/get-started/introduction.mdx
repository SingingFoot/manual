...
<table style="border-collapse: collapse; width: 100%;">
  ...
  <tr>
    <td colspan="4" style="border: 1px solid grey; padding: 8px;">
      ...
      - <strong>NuvoAir</strong>.A digital health start-up (Boston, MA. European office in Stockholm, Sweden), focused on respiratory care, offers a complex solution for assessing the health of patients with respiratory diseases. NuvoAir Air Next spirometer + NuvoAir inhaler sensor.<br />
